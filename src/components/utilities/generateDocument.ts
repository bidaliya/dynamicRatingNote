              ...
              const labelParagraph = new Paragraph({
                ...
                indent: {
                  left: table.label?.styles?.margin?.left
                    ? Math.round(
                        pxToTwips(parseInt(table.label.styles.margin.left))
                      )
                    : 0,
                  right: table.label?.styles?.margin?.right
                    ? Math.round(
                        pxToTwips(parseInt(table.label.styles.margin.right))
                      )
                    : 0,
                },
                spacing: {
                  before: table.label?.styles?.margin?.top
                    ? Math.round(
                        pxToTwips(parseInt(table.label.styles.margin.top))
                      )
                    : 0,
                  after: table.label?.styles?.margin?.bottom
                    ? Math.round(
                        pxToTwips(parseInt(table.label.styles.margin.bottom))
                      )
                    : 0,
                },
              });
              ...
              return new Paragraph({
                ...
                indent: {
                  left: textComponent.styles?.margin?.left
                    ? Math.round(
                        pxToTwips(parseInt(textComponent.styles.margin.left))
                      )
                    : 0,
                  right: textComponent.styles?.margin?.right
                    ? Math.round(
                        pxToTwips(parseInt(textComponent.styles.margin.right))
                      )
                    : 0,
                },
                spacing: {
                  before: textComponent.styles?.margin?.top
                    ? Math.round(
                        pxToTwips(parseInt(textComponent.styles.margin.top))
                      )
                    : 0,
                  after: textComponent.styles?.margin?.bottom
                    ? Math.round(
                        pxToTwips(parseInt(textComponent.styles.margin.bottom))
                      )
                    : 0,
                },
              });
